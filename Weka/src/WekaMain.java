...
public class WekaMain {
	...
	/*
	 * Esta función clasificador, permite a través del dataset de entrenamiento,
...
/*
		...
		// Código que permite subir la información de todos los archivos que tiene en una carpeta, delimitándolos con un punto
		public static void clasificador(){ 
